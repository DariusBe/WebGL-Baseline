...
export class Attribute {
   ...
   * @param {number} stride - Size of a single vertex in BYTES (0 if tightly packed).
   ...
   * @param {boolean} [separate=false] - Whether this attribute is separate from the main buffer.
   *
   */
  constructor(
    name,
